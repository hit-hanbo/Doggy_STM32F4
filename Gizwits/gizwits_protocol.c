...
static int8_t ICACHE_FLASH_ATTR gizDataPoint2Event(gizwitsIssued_t *issuedData, eventInfo_t *info, dataPoint_t *dataPoints)
{
    ...
    if(0x01 == issuedData->attrFlags.flagGas)
    {
        info->event[info->num] = EVENT_Gas;
        info->num++;
        dataPoints->valueGas = gizStandardDecompressionValue(Gas_BYTEOFFSET,Gas_BITOFFSET,Gas_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagFire_1)
    {
        info->event[info->num] = EVENT_Fire_1;
        info->num++;
        dataPoints->valueFire_1 = gizStandardDecompressionValue(Fire_1_BYTEOFFSET,Fire_1_BITOFFSET,Fire_1_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagFire_2)
    {
        info->event[info->num] = EVENT_Fire_2;
        info->num++;
        dataPoints->valueFire_2 = gizStandardDecompressionValue(Fire_2_BYTEOFFSET,Fire_2_BITOFFSET,Fire_2_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagFire_3)
    {
        info->event[info->num] = EVENT_Fire_3;
        info->num++;
        dataPoints->valueFire_3 = gizStandardDecompressionValue(Fire_3_BYTEOFFSET,Fire_3_BITOFFSET,Fire_3_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagFire_4)
    {
        info->event[info->num] = EVENT_Fire_4;
        info->num++;
        dataPoints->valueFire_4 = gizStandardDecompressionValue(Fire_4_BYTEOFFSET,Fire_4_BITOFFSET,Fire_4_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagTemperate)
    {
        info->event[info->num] = EVENT_Temperate;
        info->num++;
        dataPoints->valueTemperate = gizX2Y(Temperate_RATIO,  Temperate_ADDITION, issuedData->attrVals.valueTemperate); 
    }
...
static int8_t ICACHE_FLASH_ATTR gizCheckReport(dataPoint_t *cur, dataPoint_t *last)
{
    ...
    if(last->valueFire_2 != cur->valueFire_2)
    {
        GIZWITS_LOG("valueFire_2 Changed\n");
        ret = 1;
    }
    if(last->valueFire_3 != cur->valueFire_3)
    {
        GIZWITS_LOG("valueFire_3 Changed\n");
        ret = 1;
    }
    if(last->valueFire_4 != cur->valueFire_4)
    {
        GIZWITS_LOG("valueFire_4 Changed\n");
        ret = 1;
    }
    ...
    if(last->valueTemperate != cur->valueTemperate)
    {
        GIZWITS_LOG("valueTemperate Changed\n");
        ret = 1;
    }
...
static int8_t ICACHE_FLASH_ATTR gizDataPoints2ReportData(dataPoint_t *dataPoints , devStatus_t *devStatusPtr)
{
    ...
    devStatusPtr->valueTemperate = gizY2X(Temperate_RATIO,  Temperate_ADDITION, dataPoints->valueTemperate); 
