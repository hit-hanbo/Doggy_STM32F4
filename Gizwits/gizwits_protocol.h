...
* @{
*/
#define PRODUCT_KEY "376dffda056341fc85d5d0878c0ff2c2"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "60546555c664454d89e2c56a1048117c"
...
* @{
*/
#define Gas_BYTEOFFSET                    0
#define Gas_BITOFFSET                     0
#define Gas_LEN                           1
#define Fire_1_BYTEOFFSET                    0
#define Fire_1_BITOFFSET                     1
#define Fire_1_LEN                           1
#define Fire_2_BYTEOFFSET                    0
#define Fire_2_BITOFFSET                     2
#define Fire_2_LEN                           1
#define Fire_3_BYTEOFFSET                    0
#define Fire_3_BITOFFSET                     3
#define Fire_3_LEN                           1
#define Fire_4_BYTEOFFSET                    0
#define Fire_4_BITOFFSET                     4
#define Fire_4_LEN                           1
#define LED_BYTEOFFSET                    0
#define LED_BITOFFSET                     5
#define LED_LEN                           1

#define Temperate_RATIO                         1
#define Temperate_ADDITION                      0
#define Temperate_MIN                           0
#define Temperate_MAX                           50
/**@} */
...
typedef struct {
  uint8_t flagGas:1;
  uint8_t flagFire_1:1;
  uint8_t flagFire_2:1;
  uint8_t flagFire_3:1;
  uint8_t flagFire_4:1;
  uint8_t flagLED:1;
  uint8_t flagTemperate:1;
} attrFlags_t;
